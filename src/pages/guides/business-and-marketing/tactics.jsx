...
const TacticsPage = () => (
  <Layoutg>
    <SEO title="Indie Business Tactics" description="A list of tactics business and marketing for running a successful Indie Studio."/>
    <h1 id="top">Indie Business Tactics</h1>
    <div id="community">
        <h3>Community Growth Tactics</h3> 
        <p>
            Common Methods:
            <ul>
                <li>
                    Social Media Posts. (Reddit, Twitter, Imgur, Instagram, Facebook)
                </li>
                <li>
                    Demos
                </li>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            Consistently engage the community with posts, comments, forums, chat rooms. Collect feedback and take it into consideration when developing future updates.
                        </li>
                    </ul>
                </li>
                <li>
    ...
    <div id="expansion">
        <h3>Market Expansion Tactics</h3>
        <p>
            <ul>
                <li>
                    Diversify and release a game on all possible platforms.
                    <ul>
                        <li>
                        ...
                        <li>
                            Release on more than one PC platform. (Steam, GOG, Epic)
                        </li>
                        <li>
                ...
                <li>
                    Integrate localization and publish the game to other countries / markets.
                    <ul>
                        <li>
                            Biggest Markets for games are:
                        </li>
                        <ul>
                            <li>
                                China (Chinese)
        ...
        <p>
            Sources:
            <br/>
            <a href="http://blog.prismata.net/author/elyot/">Elyot Grnat - Creator of Prismata</a><br/>
            <a href="https://onemorestorygames.com/about/">Jean Leggett - CEO of One More Story Games</a><br/>
            <a href="https://strayfawnstudio.com/about-us/">Philomena Schwa - Founder of Stray Fawn</a><br/>
            <a href="https://www.gamasutra.com/blogs/TanyaXShort/934892/">Tanya X. Shorts - Director of Kitfox Games</a><br/>
            <a href="https://jonastyroller.myportfolio.com/about-me">Jonas Tyroller - Independent Game Designer</a><br/>
            <a href="https://www.projectfelinegame.com/developer">Raymond Cripps - Independent Game Developer</a>
        </p>
    </div>
